...
interface BaseZipIconProps extends BaseIconProps {}

export default function BaseZipIcon(props: BaseZipIconProps) {
  return (
    <BaseIcon
      component={() => (
        <svg viewBox='-4 0 64 64' xmlns='http://www.w3.org/2000/svg'>
          <path
