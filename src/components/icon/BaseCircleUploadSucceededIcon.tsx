...
interface BaseCircleUploadSucceededIcon extends BaseIconProps {}

export default function BaseCircleUploadSucceededIcon(props: BaseCircleUploadSucceededIcon) {
  return (
    <BaseIcon
      component={() => (
