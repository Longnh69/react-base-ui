...
interface BaseFileIconProps extends BaseIconProps {}

export default function BaseFileIcon(props: BaseFileIconProps) {
  return (
    <BaseIcon
      component={() => (
        <svg version='1.1' id='_x36_' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
          <g>
            <g>
              <g>
                <path
                  ...
                  d='M431.953,50.012V461.94c0,27.547-22.512,50.06-50.06,50.06H50.016
    ...
    c0.305,1.449,0.458,2.976,0.611,4.426C431.877,46.882,431.953,48.486,431.953,50.012z'
            ...
            <path
              ...
              d='M431.495,447.898v11.294c0,27.473-22.512,49.984-49.984,49.984H49.634
