...
interface BaseCircleUploadFailedIconProps extends BaseIconProps {}

export default function BaseCircleUploadFailedIcon(props: BaseCircleUploadFailedIconProps) {
  return (
    <BaseIcon
      component={() => (
