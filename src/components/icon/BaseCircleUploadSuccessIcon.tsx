...
interface BaseCircleUploadSuccessIconProps extends BaseIconProps {}

export default function BaseCircleUploadSuccessIcon(props: BaseCircleUploadSuccessIconProps) {
  return (
    <BaseIcon
      component={() => (
        <svg width='56' height='56' viewBox='0 0 56 56' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <rect width='56' height='56' rx='28' fill='currentColor' fillOpacity='0.1' />
          <path
