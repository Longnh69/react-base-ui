...
export interface BaseModalConfirmErrorFacetProps extends Omit<BaseModalProps, 'facet'> {}

export default function BaseModalConfirmErrorFacet(props: BaseModalConfirmErrorFacetProps) {
