...
export interface BaseModalConfirmSuccessFacetProps extends Omit<BaseModalProps, 'facet'> {}

export default function BaseModalConfirmSuccessFacet(props: BaseModalConfirmSuccessFacetProps) {
  ...
  return (
    ...
    >
      <BaseFlex className='flex-col items-center justify-center gap-4 py-2'>
        <BaseCircleUploadSuccessIcon className='h-[72px] w-[72px] text-primary' />
        {children}
      </BaseFlex>
    </BaseModal>
  )
